...
name: employment-law
description: >
  Employment law and HR operations skill for SME owners, HR professionals, and solicitors.
  Covers the full employee lifecycle: contracts, policies, disciplinary, grievance, capability,
  ...
  constructive dismissal, settlement, leaver, safeguarding, whistleblowing, protected
  disclosure, FWA, Fair Work Agency, or any question about employing or exiting staff.
  Also use for general HR process questions including: absence, sickness, sick note, fit note,
  check-in, daily contact, welfare check, return to work, rota, shift, on-call, reporting
  procedure, contact method, texting staff, calling staff, keeping in touch, KIT day,
  how do I handle, what should I do, is it appropriate, can I, should I, am I allowed,
  what's the process, company policy, HR policy, procedure question, best practice,
  evidence, written record, documentation, notes, file note, or any question about
  day-to-day people management and HR process.
---
...
## 2. Jurisdiction Reference Map

| Jurisdiction | Key Framework | Statutory Body |
|---|---|---|
...
> For jurisdictions not listed: read `references/jurisdiction-guide.md` for research protocol.
...
**Contracts & Offer Documents**
- Contract of employment (hourly / salaried / zero hours / annualised hours)
- Offer letter
- Variation of contract letter
- Self-employed / contractor agreement (with IR35 status flags)

**Policies**
- Disciplinary policy (with 6-month qualifying period provisions under ERA 2025, effective January 2027)
- Grievance policy
- Capability / performance management policy
- Sickness absence policy (including trigger framework, e.g. Bradford Factor)
- Anti-harassment & dignity at work policy (updated: "all reasonable steps" from October 2026)
- Flexible working policy
- Data protection / AI use policy
- Whistleblowing policy (updated: sexual harassment qualifying disclosure from 6 April 2026)
- Equal opportunities policy
- Safeguarding policy (mandatory for health and social care providers)

**Lifecycle Letters**
- Invitation to disciplinary / grievance / capability hearing
...
- Maternity / paternity / shared parental leave confirmation letters
...
own view for the employer's, but they will examine whether the decision was within that range.
...
(e.g. involvement in the events being investigated, prior relationship history with the employee),
separation of roles is even more critical and an external HR consultant or solicitor should chair
...
From January 2027 this uplift applies to an uncapped award.
...
Where an employer has failed to address a known grievance (e.g. underpaid holiday pay, a promotion
handled without transparency, unresolved pay concerns raised over months) and the employee resigns,
the inaction itself may constitute the repudiatory breach. Avoidant management is not a defence.
Each unresolved legitimate complaint is a potential plank in a constructive dismissal claim.
...
- Genuine redundancy: cessation, reduced need, place closure
- Fair selection: objective criteria, avoid discriminatory pools
...
- Protective award for failure to consult: **180 days' pay per employee** (6 April 2026), no cap on
  weekly pay. With 25% Acas uplift: maximum 225 days' pay.
- Statutory redundancy pay: service × weekly pay × age multiplier (cap £751/week)
...
- Constructive knowledge test: employer liable if they "could reasonably be expected to know"
  (Sch.8 para.20 EqA)
- Key cases: *Gallop v Newport City Council* [2013] CA; *Donelien v Liberata* [2018] CA
- Progressive conditions: likely deemed disability under Sch.1 para.6 EqA even with minimal symptoms

**Vento Bands (6 April 2026):**
- Lower: £1,300 – £12,600
...
| Change | Detail |
|---|---|
| National Living Wage | £12.71/hr (21+), £10.85 (18–20), £8.00 (16–17 and apprentice) |
| SSP | £123.25/week or 80% AWE (lower). Day-one entitlement. LEL removed. Waiting days abolished. Old rules apply to sickness spells begun before 6 April 2026. |
...
| ET time limits | 3 months less one day now; **6 months less one day from October 2026** |
| Acas early conciliation | 12 weeks (doubled from 1 December 2025) |

### In Force from 1 January 2027 (ERA 2025 Phase 2):
...
| Fire and rehire | Dismissal to re-engage on worse terms becomes automatically unfair |

### Redundancy pay and other caps:
- Weekly pay cap: £751 (max statutory redundancy: £22,530)
- Unfair dismissal compensatory award until Jan 2027: £123,543 or 52 weeks' pay (lower)
- After Jan 2027: **uncapped**
...
Approximately 550 inspectors. Can investigate **proactively without a complaint**.
...
- Criminal prosecution for obstruction, false records, or failure to comply: unlimited fine + up to
...
record-keeping obligation and criminal exposure are in force from 6 April 2026.**

### FWA and proactive enforcement:
Unlike previous enforcement which required an employee complaint, the FWA can target sectors,
run spot checks, and investigate based on its own intelligence. Health and social care is a
sector identified as carrying higher compliance risk due to informal payroll practices.
...
1. The adult has needs for care and support (whether or not being met by a local authority)
...
5. IF safeguarding inquiry substantiates concern → this becomes the foundation for
   ...
   defensible. It solves the problem of thin contemporaneous documentation.
6. HR investigation begins after safeguarding process has reached a conclusion (or in
   parallel if the commissioning authority agrees and there is no risk of contamination)

### Commissioning contract exposure:
Unregulated providers operating under local authority contracts typically have safeguarding
obligations embedded in the contract. Failure to refer may constitute a contract breach
independent of employment law, and may lead to contract termination or monitoring conditions.
...
### Qualifying categories (as at April 2026):
- Criminal offence
...
- If an employee raises concerns about systemic underpayment affecting multiple workers, the
  public interest test is far more likely to be met (breach of legal obligation, multiple workers
  affected)
- If the disclosure is made to colleagues in the context of alerting them to a legal breach
  (rather than simply venting about personal pay), the public interest dimension is present
- A WhatsApp message to colleagues advising them that their holiday pay may be incorrectly
  calculated and that they have rights to challenge it may constitute a qualifying disclosure
  under "breach of a legal obligation" where the employer's calculation is genuinely wrong

**Practical rule:** Any employee communication about pay that:
(a) relates to a genuine underpayment
(b) is directed at or involves more than the individual employee
(c) is connected to a legal obligation the employer is breaching

...carries protected disclosure risk and must be treated with extreme caution. Do NOT:
- Reference the communication as a conduct allegation
- Discipline any worker for raising or passing on concerns about pay
...
Workers (not just employees) are also protected from detriment under s.47B ERA 1996. This
...
| Score | Stage | Action |
|---|---|---|
| 0–49 | No action | Informal welfare conversation recommended |
| 50–149 | Informal intervention | Return-to-work + management 1:1 |
| 150–399 | Stage 1 formal | First written warning (capability route) |
| 400–749 | Stage 2 formal | Final written warning |
| 750+ | Stage 3 formal | Consider dismissal (full capability process required) |
...
Applying trigger thresholds based on absences that were never followed up with return-to-work
conversations, or where the policy was never communicated to the employee, is procedurally
unfair and will not survive scrutiny at tribunal. The correct approach when a policy has not
...
Maternity, paternity, adoption, shared parental, and parental bereavement leave must be excluded
from Bradford Factor calculations entirely.
...
- A tribunal or employment judge will consider the full context of an employer-employee relationship
- An employer taking disciplinary action for conduct while owing that employee underpaid wages
  is at high risk of the tribunal finding the process tainted, or of the employee raising a
  grievance mid-process that must be addressed before the disciplinary can continue
- If the employee raises a grievance during the disciplinary process, the employer must consider
  whether to suspend the disciplinary, deal with both concurrently, or address the grievance
  issues within the disciplinary hearing if the subject matter is connected (Acas guidance)

**Priority order when both exist:**
1. Correct the compliance failure first (pay the arrears, issue the correct contracts)
2. Document that the correction was made proactively
3. Then commence formal process

This converts a liability into a demonstration of good faith and removes the employee's most
powerful grievance weapon before the formal process begins.
...
[Document body]
---
DRAFTING NOTES: [any flags, assumptions, or alternatives the user should consider]
```

### For situation advice:
```
SITUATION: [summary]
...
SAFEGUARDING CHECK: [applicable/not applicable]
...
### For gap analysis:
```
DOCUMENT REVIEWED: [name/type]
ASSUMED BASELINE: [legislation it was written under]
CURRENT BASELINE: [jurisdiction + current law]
GAPS IDENTIFIED:
| Clause/Section | Issue | Risk Level | Recommended Fix |
PRIORITY ACTIONS:
```
...
### The three questions to always ask on a process question:

1. **Does a policy govern this?**
...
3. **Is the action creating a written record?**
   If a process is worth doing, it is worth documenting. The difference between a phone
   call and a text is the difference between "he said / she said" and evidence. Always
   consider what medium creates the most defensible contemporaneous record.
...
**Absence reporting procedure (who the employee contacts):**
...
- For longer absences: a structured keeping-in-touch plan, documented
- Every contact during an absence period should be documented: date, method, what was
  said, employee's response
...
### Policy gap flag:
If answering a process question and no policy governs the area, flag explicitly:
"There is no policy governing this. Any action is based on general best practice only,
and inconsistency between employees is harder to defend. Consider whether a policy
should be created."
...
- Apply the two-layer policy check (Layer 1: best practice / Layer 2: company policy)
- State what the user should do, in what order, and why
- Flag risk level
...
- Say so explicitly
- State what you do know from the skill
- Recommend the user seeks qualified legal advice for the specific gap
